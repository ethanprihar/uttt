...
class Model:
    def __init__(self, board, rsf, df, sbs, spu, bpu, bs, br, wr, sc, t):
    ...
    def move(self, board):
        ...
        if not self.training or np.random.rand() > self.random_threshold:
        ...
        if self.training:
            ...
            if not board.open_board:
                ...
                if self.game_count % self.save_checkpoint == 0:
                    ...
                    with open(f'checkpoints/model_{self.game_count}/param.pkl', 'wb') as file:
